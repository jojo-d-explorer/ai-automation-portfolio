...
Before deduplication, standardize Work_Arrangement values in weekly results:

Apply these mappings:
- Any variant of "Remote" + "US/USA/United States" → **Remote-US**
- Any variant of "Remote" + "Americas/LATAM/Canada" → **Remote-Americas**
- Generic "Remote" or "Remote Worldwide/Global/EMEA/Europe" → **Remote-Global**
- Any "Hybrid" variant (including "Remote/Hybrid") → **Hybrid**
- Location-specific without Remote/Hybrid (e.g., "Paris", "Vienna", "Manila") → **In-Office**
- Unclear cases → **N/A**

This ensures consistency when merging with master database. Do not leave Work_Arrangement as generic "Remote" — always classify into the specific category above.
